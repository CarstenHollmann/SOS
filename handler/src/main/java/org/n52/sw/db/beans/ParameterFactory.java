...
import org.n52.series.db.beans.parameter.ParameterXml;
...
public class ParameterFactory implements ValueVisitor<ValuedParameter<?,?>, OwsExceptionReport> {
    ...
    public Class<? extends ParameterXml> xmlClass() {
        return ParameterXml.class;
    }

    public ParameterXml xml() throws OwsExceptionReport {
