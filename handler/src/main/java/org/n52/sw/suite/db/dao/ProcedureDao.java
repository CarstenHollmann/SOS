...
public class ProcedureDao
    ...
    public Map<String, Collection<String>> getParentMap() {
        ...
        criteria.createAlias(ProcedureEntity.PARENTS, "pp", JoinType.LEFT_OUTER_JOIN);
     ...
     */
    @SuppressWarnings("unchecked")
    public List<String> getProceduresForFeatureOfInterest(FeatureEntity feature)
     ...
     */
    @SuppressWarnings("unchecked")
    public List<String> getProcedureIdentifiersForOffering(String offeringIdentifier)
            throws OwsExceptionReport {
    ...
    private DetachedCriteria getDetachedCriteriaProceduresForOfferingFromObservationConstellation(
        ...
        DetachedCriteria detachedCriteria = DetachedCriteria.forClass(ObservationConstellationEntity.class);
        detachedCriteria.add(Restrictions.eq(ObservationConst ellationEntity.DELETED, false));
