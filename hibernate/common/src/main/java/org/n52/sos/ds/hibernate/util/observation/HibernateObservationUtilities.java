...
public class HibernateObservationUtilities {
     ...
     */
    public static ObservationStream createSosObservationFromObservationConstellation(ObservationConstellationEntity oc,
    ...
    /**
     * Create SOS internal observation from DatasetEntity
     *
     * @param series
     ...
     *             If procedure creation fails
     */
    public static ObservationStream createSosObservationFromDatasetEntity(DatasetEntity series, AbstractObservationRequest r,
            String pdf, OmObservationCreatorContext ctx, Session session)
            throws OwsExceptionReport, ConverterException {
        if (series instanceof EReportingDatasetEntity) {
            return createSosObservationFromEReportingDatasetEntity((EReportingDatasetEntity) series, r,
                    LocaleHelper.decode(r.getRequestedLanguage(), ctx.getDefaultLanguage()), pdf, ctx, session);
        } else {
            return createSosObservationFromDatasetEntity(series, r,
                    LocaleHelper.decode(r.getRequestedLanguage(), ctx.getDefaultLanguage()), pdf, ctx, session);
        }
    }
    ...
    public static ObservationStream createSosObservationFromDatasetEntity(DatasetEntity series, AbstractObservationRequest r,
            ...
            throws OwsExceptionReport, ConverterException {
        if (series instanceof EReportingDatasetEntity) {
            return createSosObservationFromEReportingDatasetEntity((EReportingDatasetEntity) series, r, l, pdf, ctx, session);
        }
        return new DatasetOmObservationCreator(series, r, l, pdf, ctx, session).create();
    }

    public static ObservationStream createSosObservationFromEReportingDatasetEntity(EReportingDatasetEntity series,
            AbstractObservationRequest r, String pdf, OmObservationCreatorContext ctx, Session session)
            throws OwsExceptionReport, ConverterException {
        return createSosObservationFromEReportingDatasetEntity(series, r,
                LocaleHelper.decode(r.getRequestedLanguage(), ctx.getDefaultLanguage()), pdf, ctx, session);
    }
    ...
    public static ObservationStream createSosObservationFromEReportingDatasetEntity(EReportingDatasetEntity series,
            ...
            throws OwsExceptionReport, ConverterException {
        return new EReportingDatasetOmObservationCreator(series, r, l, pdf, ctx, session).create();
    }
