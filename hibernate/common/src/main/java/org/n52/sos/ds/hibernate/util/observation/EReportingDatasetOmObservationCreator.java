...
public class EReportingDatasetOmObservationCreator extends DatasetOmObservationCreator {

    public EReportingDatasetOmObservationCreator(EReportingDatasetEntity dataset,
                                                AbstractObservationRequest request,
                                                Locale i18n,
                                                String pdf,
                                                OmObservationCreatorContext creatorContext,
                                                Session session) {
        super(dataset, request, i18n, pdf, creatorContext, session);
    }
