...
public interface AdditionalObservationCreator extends Component<AdditionalObservationCreatorKey> {
    ...
    OmObservation create(OmObservation omObservation, DatasetEntity dataset);
    ...
    OmObservation create(OmObservation omObservation, DatasetEntity dataset, Session session) throws CodedException;
